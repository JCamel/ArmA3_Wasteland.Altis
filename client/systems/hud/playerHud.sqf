...
while {true} do
{
	...
	hudServerTextbox = _ui displayCtrl hud_server_idc;
	
	_serverString = format ["<t color='#A0FFFFFF'>Server: BIB #%1 Wasteland Altis</t>", call A3W_extDB_ServerID];
	_serverString = format ["%1<br/><t color='#A0FFFFFF'>Teamspeak: ts3.bibgaming.com<br/>Website: bibgaming.com</t>",_serverString];
